...
export const Post = ({ post, replies }) => {
    ...
    return (
        ...
        >
            <img src={post.imgPost} className="card-img-top" alt={post._id} />
            <div className="card-body">
                ...
                <div className="tags">
                    {
                        post.tags.map((tag, idx) => <a href="" key={idx} className="mr-1"><span>#</span>{tag}</a>)
                    }
                </div>
